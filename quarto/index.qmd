...
To start, we assume that one of the species, $N_1$ becomes infected with a generalized pathogen. A proportion of the population is infected, and this pathogen can have some impact on the ability of that population to grow. Our system \ref{eqn:simple-lv-1} now can be represented as
